...
This folder contains all documentation for the AWS Cloud Engineer committed role and 20-week learning roadmap.

## Documents

- [01-role-description.md](./01-role-description.md) — Role responsibilities, skills, and success criteria
- [02-roadmap.md](./02-roadmap.md) — 20-week structured learning roadmap
